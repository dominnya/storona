...
<h1>
  ...
  <sup>
    <strong>
      <code>&nbsp;<a href="https://storona.domin.zip/adapters/express/">Documentation</a>&nbsp;</code>
    </strong>
  </sup>
</h1>

This package is an adapter for [storona](https://storona.domin.zip/) file-based router. It allows to use [Express](https://expressjs.com/) web framework with storona.
